...
#define   CONNECT_SSID			"Home"		/* SSID of the Access Point to connect */
#define   PSK					"satanist"			/* Pre-Shared key */
...
#define   IP_ADDRESS			{192, 168, 2, 40 }	/* Static IP Address of the device */
#define   SUBNET_MASK			{255, 255, 255, 0}	/* SUBNET MASK of the device */
#define   GATEWAY_ADDRESS		{192, 168, 2, 1}	/* GATEWAY ADDRESS of the device */

#define   POWERSAVE_MODE		POWER_MODE0			/* POWER_MODE0/POWER_MODE1/POWER_MODE2 */

#define   FIRMWARE_UPGRADE		DISABLE				/* ENABLE / DISABLE */
